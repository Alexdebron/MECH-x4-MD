...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/cnw-db/Mech-vx/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/cnw-db/Mech-vx/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "Mech-vx-main");
